...
namespace RefactorEventApp
{
    public class Program
    {
        ...
        {
            ITool tool = new PowerTool("Hammer", "nails", "wood", 7.00);
            ToolService toolService = new ToolService(tool);
            toolService.ToolName();
            toolService.FastenerType();
            toolService.HandleOrPowerType();
            toolService.PriceTag();
